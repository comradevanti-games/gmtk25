...
namespace GMTK25.Shop
{
    public sealed class ShopKeeper : MonoBehaviour
    {
        ...
        private void OpenShop(int itemCount)
        {
            ...
            var free = pickupSpawner.SpawnPickup(new PickupSpawner.Request(
                normalBulletType,
            ...
            var freeSign = Instantiate(priceCounterPrefab,
                ...
                Quaternion.identity);
            freeSign.GetComponent<PriceCounter>()
                .Init(free, normalBulletType.Price);
